  ...
  grid_page(
    ...
    grid_nested(
      ...
      grid_card("people_title",
        has_border = FALSE,
        conditionalPanel(
          condition = "['scotland_ltla_shp', 'england_ltla_shp', 'brc_central_shp', 'brc_london_shp', 'brc_north_shp', 'brc_south_shp', 'brc_southeast_shp'].includes(input['geography-selectGeography'])",
