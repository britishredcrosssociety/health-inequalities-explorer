...
grid_config <- new_gridlayout(
  c(
    "1rem    1fr     25px            175px            300px                     300px                     175px           25px    1fr   ",
    ...
    "360px   blank1  summary_metrics summary_metrics  summary_metrics           summary_metrics           summary_metrics help_button blank2",
    ...
    "480px   blank1  secondary_care  secondary_care   secondary_care            secondary_care            secondary_care  blank16     blank2",
    "auto    blank1  blank13         blank7           secondary_descriptions    secondary_descriptions    blank8          blank16     blank2",
    "auto    blank1  blank13         blank7           demographics_title        demographics_title        blank8          blank16     blank2",
    "1320px  blank1  demographics    demographics     demographics              demographics              demographics    blank16     blank2",
    "auto    blank1  blank14         blank9           demographics_descriptions demographics_descriptions blank10         blank16     blank2",
    "auto    blank1  blank14         blank9           footer                    footer                    blank10         blank16     blank2"
  )
)
