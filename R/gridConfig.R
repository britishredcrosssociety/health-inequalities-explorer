...
grid_config <- new_gridlayout(
  c(
    ...
    "180px   blank1  blank11         blank3           select_region             map                       blank4          blank15                  blank2",
    "180px   blank1  blank11         blank3           select_geography          map                       blank4          blank15                  blank2",
    "180px   blank1  blank11         blank3           select_areas              map                       blank4          blank15                  blank2",
    ...
    "auto    blank1  hi_plot         hi_plot          hi_plot                   hi_plot                   hi_plot         help_button_health_index blank2",
